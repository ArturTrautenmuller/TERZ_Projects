...
def TransformPrimary():
    ...
    Primary.rename(columns={'Coal Consumption - EJ': 'Coal'}, inplace=True)

    Gas_prm = pd.read_csv(variables.ExtractPath + '\\Source\\Primary\\Gas.csv')
    Gas_prm.rename(columns={'Gas Consumption - EJ': 'Gas'}, inplace=True)
    ...
    Hydro_prm.rename(columns={'Hydro (TWh – sub method)': 'Hydro'}, inplace=True)
    ...
    Nuclear_prm.rename(columns={'Nuclear (TWh – sub method)': 'Nuclear'}, inplace=True)
    ...
    Oil_prm.rename(columns={'Oil Consumption - EJ': 'Oil'}, inplace=True)
    ...
    Renewables_prm.rename(columns={'Renewables (TWh – sub method)': 'Renewables'}, inplace=True)
    ...
    Solar_prm.rename(columns={'Solar (TWh – sub method)': 'Solar'}, inplace=True)
    ...
    Wind_prm.rename(columns={'Wind (TWh – sub method)': 'Wind'}, inplace=True)
